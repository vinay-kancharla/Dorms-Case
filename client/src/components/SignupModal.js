...
const SignupModal = (props) => {
	...
	const [passwordConfirmValidator, setPasswordConfirmValidator] =
		useState("");
	...
	let validate = () => {
		...
		if (passwordValue == "") {
			...
			setPasswordValidator(
				"Password value must match with confirmed in!"
			);
		...
		try {
			...
			if (response.ok) {
				...
				if (userIdentifier === "null") {
					console.log(
						"Failed to create account due to invalid credentials"
					);
